...
class Plante(models.Model):
    ...
    type = models.ForeignKey(TypePlante, on_delete=models.CASCADE)
...
class Structure(models.Model):
    ...
    type = models.ForeignKey(TypeStructure, on_delete=models.CASCADE)
...
class Localite(models.Model):
    ...
    type = models.ForeignKey(TypeLocalite, on_delete=models.CASCADE)
...
class SourceFinance(models.Model):
    ...
    def __str__(self):
        return f"Source de financement de {self.partenaire} pour {self.activite}"
